...
params:
  new_directory:
    value: "/home/drew/code/lpj-guess/.data/runs/narclim2/1deg/trunk"
  new_name:
    value: NULL
  old_directory:
    value: "/home/drew/code/lpj-guess/.data/runs/narclim2/1deg/trunk"
...
do_bom_lai <- TRUE
do_grass_dist <- TRUE # TODO: download dave_lai.out.gz from gadi when it's back online; also backup all outputs onto hie-storage
...
```{r luigi_lai}
if (do_bom_lai) {
    bom_lai <- benchmark_lai(settings, params, tables)
