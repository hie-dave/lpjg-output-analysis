...
#' @param source_descriptions Descriptions of the data sources (see: [sanitise_source])
...
#' for debugging).
#' @param text_multiplier Multiplier for text size. Decrease for smaller text.
